        ...
        <div className="p-8">
          <Link to="/" className="flex flex-col items-center gap-2 group">
            ...
            <div className="text-center">
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] mt-2">Admin Space</p>
            </div>
          </Link>
        </div>
        ...
        <div className="p-6 mt-auto border-t border-slate-100">
          <div className="flex items-center justify-between px-2">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-full bg-slate-200 border-2 border-white shadow-sm flex items-center justify-center text-sm font-medium text-slate-600">
                A
              </div>
              <div className="flex flex-col">
                <span className="text-sm font-semibold text-slate-700">Administrateur</span>
                <span className="text-xs text-slate-500 truncate w-24">admin@dmplus.com</span>
              </div>
            </div>
            <button 
              onClick={() => {
