   ...
   <section className="py-2 md:py-6 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-6xl relative z-10">
          ...
          <div className="relative flex flex-col lg:flex-row items-center">
            {/* Image */}
            <div className="relative w-auto h-[250px] md:h-[350px] lg:h-[400px] rounded-2xl overflow-hidden">
              <img
            ...
            <div
              className="relative lg:absolute lg:right-0 lg:top-1/2 lg:-translate-y-1/2 
                      ...
                      rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg border border-border/30
                      mt-4 lg:mt-0"
            >
              ...
              <span className="text-primary text-4xl md:text-5xl lg:text-6xl leading-none">"</span>
