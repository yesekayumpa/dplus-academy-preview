...
import {
  Search, Clock, Users, Star, Award, Play, Heart, Calendar,
  MapPin, Eye, Sparkles, GraduationCap, X, CheckCircle, Target
} from "lucide-react";
...
const categoryConfig: Record<string, { bg: string; text: string; border: string }> = {
  ...
  "Sur Mesure": { bg: "bg-purple-50", text: "text-purple-700", border: "border-purple-200" },
};
...
const SurMesurePage = () => {
  ...
  const courses = useMemo(() => {
    ...
    const rawFiltered = apiFormations.filter(
      f => f.format.slug === "mentored-courses" || f.format.slug === "sur-mesure"
    );
    ...
    return rawFiltered.map(f => {
      ...
      return {
        ...
        tagline: "Accompagnement individuel premium",
        description: f.format.description || "Formation sur mesure proposée par DM+ Academy.",
        ...
        location: "Présentiel ou En ligne",
        mode: "hybrid",
        ...
        participants: f.capacite || 10,
        category: f.categorie?.libelle || "Sur Mesure",
  ...
  return (
    <Layout>
      <div className="min-h-screen bg-white">
        {/* Hero Section */}
        <section className="relative min-h-[300px] sm:min-h-[400px] overflow-hidden pt-24 pb-16 sm:pt-32 sm:pb-24 lg:pt-40 lg:pb-32 bg-[#0f0505]">
          <div className="absolute inset-0">
            <img
              src="/assets/Masterclass.jpg"
              alt="Mentored Courses Background"
              className="w-full h-full object-cover opacity-20"
              onError={(e) => {
                (e.currentTarget as HTMLImageElement).src = "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800&fit=crop&q=80";
              }}
            />
          ...
          <div className="relative container mx-auto px-4 sm:px-6 h-full max-w-7xl flex flex-col justify-center">
            <motion.div
            ...
            >
              ...
              <p className="text-base sm:text-lg text-white/70 max-w-2xl mb-10 leading-relaxed">
                Des formations entièrement personnalisées avec un accompagnement individuel par des experts DM+ Academy. Atteignez vos objectifs professionnels à votre rythme.
              </p>
              <div className="flex flex-wrap gap-4">
                <button className="px-6 py-3.5 bg-white text-gray-900 text-sm font-bold rounded-2xl hover:bg-gray-100 transition-all transform hover:scale-105 shadow-xl">
                  Demander un devis
                </button>
                <button className="px-6 py-3.5 border border-white/20 bg-white/5 backdrop-blur-sm text-white text-sm font-bold rounded-2xl hover:bg-white/10 transition-all">
          ...
          {formationsLoading ? (
            ...
            <div className="mb-12">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Formations Sur Mesure</h2>
                <span className="hidden sm:inline px-3 py-1 bg-purple-100 text-purple-700 text-sm font-medium rounded-full">
        ...
        <div className="bg-gradient-to-r from-[hsl(var(--academy-primary))] to-[hsl(var(--academy-primary)/80%)] p-6 text-white">
          ...
          <div className="grid grid-cols-3 gap-4 bg-white/10 rounded-2xl p-4">
            <div className="text-center">
              ...
              <div className="text-sm text-white/80">Accompagnement individuel</div>
            </div>
            <div className="text-center">
