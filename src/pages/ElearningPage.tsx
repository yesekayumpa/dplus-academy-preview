...
const courses = [
  ...
  },
  {
    ...
    instructor: "Jean-Marc Designer",
    instructorTitle: "Expert en Design Graphique",
    instructorAvatar:
      "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80",
    price: 4900,
    originalPrice: 9900,
    image:
      "/pack-design-graphique-removebg-preview.png",
    category: "Design",
    level: "Débutant",
    duration: "45h",
    students: 12500,
    ...
    longDescription: "Devenez un professionnel du graphisme avec cette formation complète. Maîtrisez Photoshop pour le retouche photo, Illustrator pour le design vectoriel, et InDesign pour la mise en page professionnelle. Formation idéale pour les graphistes, marketeurs et créatifs.",
    features: [
      "Photoshop CC",
      "Illustrator CC", 
      "InDesign CC",
      "Pack Marketing Digital",
      "Pack Montage Vidéo",
      "Certificat"
    ],
    icon: Palette,
  ...
  {
    id: 10,
    title: "Pack Vidéo Pro",
    instructor: "Marc Vidéaste",
    instructorTitle: "Monteur Professionnel",
    instructorAvatar:
      "https://images.unsplash.com/photo-1507003211169-0a1dd72210f3?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80",
    price: 5500,
    originalPrice: 10900,
    ...
    longDescription: "Maîtrisez l'art du montage vidéo avec ce pack professionnel. Apprenez CapCut pour les montages rapides sur mobile, et Premiere Pro pour les productions professionnelles. Formation complète pour les créateurs de contenu, vidéastes et professionnels du marketing vidéo.",
    features: [
      "CapCut Mobile",
      "Premiere Pro CC",
      "Effets spéciaux",
    ...
    studentsCount: 8900,
    lastUpdated: "Mars 2024",
    tags: ["CapCut", "Premiere Pro", "Montage", "Vidéo"],
    modules: 18,
    language: "Français",
    certificate: true,
    projects: 12,
  },
  {
    ...
    instructor: "Sophie Marketing",
    instructorTitle: "Stratège Digital",
    instructorAvatar:
      "https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80",
    price: 4500,
    originalPrice: 8900,
    ...
    updateVersion: "v3.0",
    updateDate: "2024-03-15",
    longDescription: "Devenez un expert en marketing digital avec cette formation avancée. Maîtrisez le SEO, le SEA, les réseaux sociaux, l'emailing et l'analyse de données. Formation complète pour les marketeurs qui veulent développer des stratégies digitales performantes.",
    features: [
      "SEO/SEA avancé",
      "Social Media Pro",
      "Email Marketing",
    ...
    studentsCount: 15600,
    lastUpdated: "Mars 2024",
    tags: ["SEO", "SEA", "Social Media", "Analytics"],
    modules: 16,
    language: "Français",
    certificate: true,
    projects: 8,
  },
  {
    ...
    originalPrice: 12900,
    image:
      "/programming-background-with-person-working-with-codes-computer_23-2150010125.jpg",
    category: "Programmation",
    level: "Intermédiaire",
    duration: "60h",
    students: 11200,
    ...
    longDescription: "Devenez un développeur web complet avec cette formation full-stack. Maîtrisez HTML5, CSS3, JavaScript, React, Node.js et MongoDB. Apprenez à créer des applications web modernes et performantes de A à Z.",
    features: [
      "HTML5/CSS3",
      "JavaScript ES6+",
      "React.js",
...
const ElearningPage = () => {
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [selectedCategory, selectedLevel, searchQuery, priceRange]);
