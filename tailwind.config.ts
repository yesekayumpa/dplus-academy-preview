  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        investment: {
          DEFAULT: "hsl(var(--investment-primary))",
          light: "hsl(var(--investment-light))",
        },
        tech: {
          DEFAULT: "hsl(var(--tech-primary))",
        ...
        hubs: {
          DEFAULT: "hsl(var(--hubs-primary))",
          light: "hsl(var(--hubs-light))",
        },
        distribution: {
          DEFAULT: "hsl(var(--distribution-primary))",
          light: "hsl(var(--distribution-light))",
        },
        analytics: {
          DEFAULT: "hsl(var(--analytics-primary))",
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px rgba(18, 102, 164, 0.3)" },
          "50%": { boxShadow: "0 0 40px rgba(18, 102, 164, 0.6)" },
        },
        "gradient-shift": {
